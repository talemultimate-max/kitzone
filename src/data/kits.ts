...
import bayernOrangeGreyKitImg from './607dfa7d69.webp';
import bayernGreenBlackKitImg from './760bb75a14.webp';
import bayernGreenBlackTracksuitImg from './6070892c4a.webp';
import bayernOrangeGreyTracksuitImg from './0924457e20.webp';
import bayernDarkOrangeTracksuitImg from './36ea9e7752.webp';
import bayernSpecialCrackImg from './6f3460d2dc.webp';
import bayernRetroDiamondBlueRedImg from './9f5e224d97.webp';
import bayernOrangeWindbreakerImg from './980d63bc94.webp';
...
// --- BAYERN MONACO ---
  ...
  {
    id: 'bayern-orange-grey-kit',
    team: 'Bayern Monaco',
    title: 'Kit Allenamento Bayern Monaco Arancione/Grigio',
    category: 'Bundesliga',
    price: 45,
    originalPrice: 90,
    badge: 'Training Kit',
    ...
    bgGradient: 'from-orange-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernOrangeGreyKitImg)],
    customPatches: [],
  },
  {
    id: 'bayern-green-black-kit',
    team: 'Bayern Monaco',
    title: 'Kit Allenamento Bayern Monaco Verde/Nero',
    category: 'Bundesliga',
    price: 45,
    originalPrice: 90,
    badge: 'Training Kit',
    ...
    bgGradient: 'from-emerald-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernGreenBlackKitImg)],
    customPatches: [],
  },
  {
    id: 'bayern-green-black-tracksuit',
    team: 'Bayern Monaco',
    title: 'Tuta Rappresentanza Bayern Monaco Verde/Nera',
    category: 'Tute',
    price: 60,
    originalPrice: 120,
    badge: 'Tracksuit',
    ...
    bgGradient: 'from-emerald-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernGreenBlackTracksuitImg)],
    customPatches: [],
  },
  {
    id: 'bayern-orange-grey-tracksuit',
    team: 'Bayern Monaco',
    title: 'Tuta Rappresentanza Bayern Monaco Arancione/Grigia',
    category: 'Tute',
    price: 60,
    originalPrice: 120,
    badge: 'Tracksuit',
    ...
    bgGradient: 'from-orange-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernOrangeGreyTracksuitImg)],
    customPatches: [],
  },
  {
    id: 'bayern-dark-orange-tracksuit',
    team: 'Bayern Monaco',
    title: 'Tuta Rappresentanza Bayern Monaco Grigia/Arancione',
    category: 'Tute',
    price: 60,
    originalPrice: 120,
    badge: 'Tracksuit',
    ...
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernDarkOrangeTracksuitImg)],
    customPatches: [],
  },
  {
    id: 'bayern-special-crack',
    team: 'Bayern Monaco',
    title: 'Maglia Special Edition Bayern Monaco "Nummer Zehn"',
    category: 'Retro Vintage',
    price: 35,
    originalPrice: 75,
    badge: 'Limited Edition',
    ...
    bgGradient: 'from-red-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernSpecialCrackImg)],
    customPatches: [],
  },
  {
    id: 'bayern-retro-diamond-blue-red',
    team: 'Bayern Monaco',
    title: 'Maglia Retro Bayern Monaco Diamond Blu/Rossa',
    category: 'Retro Vintage',
    price: 35,
    originalPrice: 75,
    badge: 'Retro Icon',
    ...
    bgGradient: 'from-blue-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernRetroDiamondBlueRedImg)],
    customPatches: [],
  },
  {
    id: 'bayern-orange-windbreaker',
    team: 'Bayern Monaco',
    title: 'Giacca Antivento Bayern Monaco Arancione/Grigia',
    category: 'Tute',
    price: 60,
    originalPrice: 120,
    badge: 'Windbreaker',
    ...
    bgGradient: 'from-orange-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernOrangeWindbreakerImg)],
    customPatches: [],
  },
  {
    id: 'bayern-abstract-white-blue-red',
    team: 'Bayern Monaco',
    title: 'Maglia Special Edition Bayern Monaco Abstract Multicolore',
    category: 'Retro Vintage',
    price: 35,
    originalPrice: 75,
    badge: 'Special Edition',
    tagColor: 'bg-purple-500/10 text-purple-400 border-purple-500/20',
    bgGradient: 'from-indigo-950/40 to-slate-900',
    availableSizes: ['S', 'M', 'L', 'XL', '2XL'],
    images: [getSrc(bayernAbstractWhiteBlueRedImg)],
    customPatches: [],
  },
  {
    id: 'bayern-panda-cream',
    team: 'Bayern Monaco',
    title: 'Maglia Special Edition Bayern Monaco "Panda" Cream',
    category: 'Retro Vintage',
    price: 35,
    originalPrice: 75,
    badge: 'Special Edition',
